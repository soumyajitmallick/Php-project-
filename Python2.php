...
<button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle Sidebar">
    ...
    <div style="flex-grow: 1; padding: 20px;">
      <h3 style="font-size: 20px;"> Python – Part 2</h3>
      <!-- <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none;">Home</button> -->
      <div style=" padding: 20px; margin-top: 20px;">
        <h5>Welcome to Part 2 of the Python Crash Course series!</h5>
       <h5>In this tutorial, we’ll dive deeper into Python and explore some powerful tools that make your code smarter and more efficient. You’ll learn about:</h5>
       <h5>🔢 Operators – Arithmetic, Comparison & Logical</h5>

       <h5>🔀 Conditional statements – if, else, and elif</h5>

       <h5>🔄 Loops – for and while loops to repeat actions</h5>

         <div class="tip-box">
 
  <p>Run this tutorial notebook on <a href="https://colab.research.google.com/drive/1Sq6LjL8sktwJ0HkMQ3gPg_OnX_vKPYuC?usp=sharing" target="_blank">Google Colab</a>.</p>
</div>
      </div>
      <div style="margin-top: 40px;">
  <a href="Python1.php" style="text-decoration: none; margin-right: 10px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none; border-radius: 5px;">
      « Prev
    </button>
  </a>
  <a href="Python3.php" style="text-decoration: none; margin-left: 140px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none; border-radius: 5px;">
      Next »
    </button>
  </a>
