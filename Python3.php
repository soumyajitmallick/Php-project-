...
<button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle Sidebar">
    ...
    <div style="flex-grow: 1; padding: 20px;">
      <h3 style="font-size: 20px;"> Python – Part 3</h3>
      <!-- <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none;">Home</button> -->
      <div style=" padding: 20px; margin-top: 20px;">
        <h5>Welcome to Part 3 of the Python Crash Course — the final chapter in your beginner Python journey.</h5>
        <h5> We’re super excited that you’ve made it this far! 🎉</h5>
        <h5>In this notebook, we’ll cover two powerful programming concepts:</h5>
        <h5>🧩 Functional Programming</h5>
        <h5>🏛️ Object-Oriented Programming (OOP)</h5>
        <div class="tip-box">
 
  <p>Run this tutorial notebook on <a href="https://colab.research.google.com/drive/1jt5jBMIN2Ghb4McTm7wzpXo7ScZDCVlK?usp=sharing" target="_blank">Google Colab</a>.</p>
</div>
      </div>
       <div style="margin-top: 40px;">
  <a href="Python2.php" style="text-decoration: none; margin-right: 10px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none; border-radius: 5px;">
      « Prev
    </button>
  </a>
  <a href="PythonConclusion.php" style="text-decoration: none; margin-left: 140px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none; border-radius: 5px;">
      Next »
    </button>
  </a>
