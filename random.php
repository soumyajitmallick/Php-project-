...
<button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle Sidebar">
    ...
    <div style="flex-grow: 1; padding: 20px;">
      <h3 style="font-size: 20px;">Random Forest</h3>
      <!-- <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none;">Home</button> -->
      <div style=" padding: 20px; margin-top: 20px;">
        <h5>Welcome to the Random Forest </h5>
        <h5>In this easy-to-understand session, we’ll explore how the Random Forest algorithm works and how to build one using Python. You’ll learn:</h5>
        <h5>What is a Random Forest and how it improves accuracy</h5>
        <h5> The concept of Decision Trees and how multiple trees make a forest</h5>
        <h5> What is bagging and how it helps avoid overfitting</h5>
        <h5>How to train and test a Random Forest model using Scikit-learn</h5>
        <h5> Real-world use cases like credit scoring, fraud detection, and more</h5>
         
   <div class="tip-box">
 
  <p>Run this tutorial notebook on <a href="https://colab.research.google.com/drive/1qYanhuNI6e9-ohaNSf2G28Z34AljRyuT?usp=sharing" target="_blank">Google Colab</a>.</p>
</div>
      </div>
      <div style="margin-top: 40px;">
  <a href="knearest.php" style="text-decoration: none; margin-right: 10px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      « Prev
    </button>
  </a>
  <a href="support.php" style="text-decoration: none; margin-left: 140px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      Next »
    </button>
  </a>
