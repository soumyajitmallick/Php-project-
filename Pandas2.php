...
<button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle Sidebar">
    ...
    <div style="flex-grow: 1; padding: 20px;">
      <h3 style="font-size: 20px;">Pandas</h3>
      <!-- <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none;">Home</button> -->
      <div style=" padding: 20px; margin-top: 20px;">
        <h5>Welcome to the Pandas Crash Course!!</h5>
        <h5>In this beginner-friendly session, we’ll explore the basics of Pandas with a hands-on approach. You’ll learn:</h5>
        <h5> What is Pandas and why we use it</h5>
        <h5>How to install and import Pandas</h5>
        <h5>Creating Pandas DataFrames and Series</h5>
        <h5> Difference between lists, dictionaries, and Pandas DataFrames</h5>
        <h5>Basic operations using Pandas (e.g., filtering, sorting, and aggregating data)</h5>
         
   <div class="tip-box">
 
  <p>Run this tutorial notebook on <a href="https://colab.research.google.com/drive/1rvQerm8Q6n11L-lrQdEQX8NDfwsIG98W?usp=sharing" target="_blank">Google Colab</a>.</p>
</div>
      </div>
      <div style="margin-top: 40px;">
  <a href="Numpy1.php" style="text-decoration: none; margin-right: 10px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      « Prev
    </button>
  </a>
  <a href="Matplotlib3.php" style="text-decoration: none; margin-left: 140px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      Next »
    </button>
  </a>
