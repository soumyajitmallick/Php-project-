...
<button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle Sidebar">
    ...
    <div style="flex-grow: 1; padding: 20px;">
      <h3 style="font-size: 20px;">Seaborn</h3>
      <!-- <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none;">Home</button> -->
      <div style=" padding: 20px; margin-top: 20px;">
        <h5>Welcome to the Seaborn Crash Course!!</h5>
        <h5>In this beginner-friendly session, we’ll explore the basics of Seaborn with a hands-on approach. You’ll learn:</h5>
        <h5> What is Seaborn and why we use it</h5>
        <h5>How to install and import Seaborn</h5>
        <h5>Creating beautiful statistical plots (bar, line, scatter, box, etc.)</h5>
        <h5> Working with built-in datasets</h5>
        <h5> Enhancing visualizations with themes, color palettes, and plot customization</h5>
         
   <div class="tip-box">
 
  <p>Run this tutorial notebook on <a href="https://colab.research.google.com/drive/1etduBUQsVHdW4OW5BI7HbqLLT1RH5QxY?usp=sharing" target="_blank">Google Colab</a>.</p>
</div>
      </div>
      <div style="margin-top: 40px;">
  <a href="Matplotlib3.php" style="text-decoration: none; margin-right: 10px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      « Prev
    </button>
  </a>
  <!-- <a href="Python2.php" style="text-decoration: none; margin-left: 140px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      Next »
    </button>
  </a> -->
