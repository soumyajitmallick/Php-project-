...
<button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle Sidebar">
    ...
    <div style="flex-grow: 1; padding: 20px;">
      <h3 style="font-size: 20px;">NumPy</h3>
      <!-- <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none;">Home</button> -->
      <div style=" padding: 20px; margin-top: 20px;">
        <h5>Welcome to NumPy Crash Course!!</h5>
        <h5>In this beginner-friendly session, we’ll explore the basics of NumPy with a hands-on approach. You’ll learn</h5>
        <h5> What is NumPy and why we use it</h5>
        <h5>How to install and import NumPy</h5>
        <h5>Creating NumPy arrays</h5>
        <h5> Difference between lists and NumPy arrays</h5>
        <h5> Basic operations using NumPy</h5>
         
   <div class="tip-box">
 
  <p>Run this tutorial notebook on <a href="https://colab.research.google.com/drive/1KdxtDg0rN0SS3FUaGAhf13F3NLkX0FSU?usp=sharing" target="_blank">Google Colab</a>.</p>
</div>
      </div>
