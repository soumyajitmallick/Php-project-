...
<button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle Sidebar">
    ...
    <div style="flex-grow: 1; padding: 20px;">
      <h3 style="font-size: 20px;">Decision Tree</h3>
      <!-- <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none;">Home</button> -->
      <div style=" padding: 20px; margin-top: 20px;">
        <h5>Welcome to the Decision Tree</h5>
        <h5>In this beginner-friendly session, we’ll explore how Decision Trees work for both classification and regression tasks in machine learning. You'll learn:</h5>
        <h5>  What is a Decision Tree and how it mimics human decision-making</h5>
        <h5> Key terms: root node, leaf node, branches, splitting, etc.</h5>
        <h5> How information gain and Gini index are used to build trees</h5>
        <h5>  Building a Decision Tree model using Scikit-learn</h5>
        <h5> Visualizing and interpreting Decision Trees</h5>
  ...
  <a href="logistic.php" style="text-decoration: none; margin-right: 10px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      « Prev
    </button>
  </a>
  <a href="knearest.php" style="text-decoration: none; margin-left: 140px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      Next »
    </button>
  </a>
