...
<button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle Sidebar">
    ...
    <div style="flex-grow: 1; padding: 20px;">
      <h3 style="font-size: 20px;">KNN</h3>
      <!-- <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none;">Home</button> -->
      <div style=" padding: 20px; margin-top: 20px;">
        <h5>Welcome to the K-Nearest Neighbors</h5>
        <h5>In this beginner-friendly session, we’ll dive into how the KNN algorithm works and how to implement it using Python. You’ll learn:</h5>
        <h5> What is KNN and how it makes predictions</h5>
        <h5>How distance (like Euclidean distance) is used to find neighbors</h5>
        <h5>The role of the “K” value and how to choose it</h5>
        <h5> Using Scikit-learn to build a KNN model</h5>
        <h5> Real-world examples like recommendation systems and image recognition</h5>
         
   <div class="tip-box">
 
  <p>Run this tutorial notebook on <a href="https://colab.research.google.com/drive/1yxRhrs3VZ2hkn-hLqMbX2b6XhFZs1jyu?usp=sharing" target="_blank">Google Colab</a>.</p>
</div>
      </div>
      <div style="margin-top: 40px;">
  <a href="decision.php" style="text-decoration: none; margin-right: 10px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      « Prev
    </button>
  </a>
  <a href="Random.php" style="text-decoration: none; margin-left: 140px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      Next »
    </button>
  </a>
