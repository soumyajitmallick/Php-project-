...
<div style="display: flex;">
  ...
  <div class="custom-sidebar" id="sidebar">
    ...
    <ul class="custom-list">
      ...
      <a href="NumPy1.php" style="text-decoration: none;">
        <li class="custom-item" onclick="highlightItem(this)" onmouseover="hoverEffect(this)" onmouseout="removeHover(this)">
          <div class="custom-slide-bg"></div>
          <span class="custom-label">NumPy</span>
        </li>
      </a>
      ...
      <a href="Seaborn4.php" style="text-decoration: none;">
        ...
        <a href="advc.php" style="text-decoration: none;">
        <li class="custom-item" onclick="highlightItem(this)" onmouseover="hoverEffect(this)" onmouseout="removeHover(this)">
          <div class="custom-slide-bg"></div>
  ...
  <div style="flex-grow: 1; padding: 20px;">
    <h3 style="font-size: 20px;">Machine Learning Tutorial</h3>
    <h5>Welcome to the Machine Learning Crash Course at CodeMonk — your free and simple guide to start learning ML step by step.</h5>
    ...
    <div style="width: 100%; max-width: 600px; margin-bottom: 20px; border: 2px solid #ccc; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
      <iframe style="width: 100%; height: 300px; border: none; display: block;" src="Video/ml.mp4" allowfullscreen></iframe>
    </div>
    ...
    <div style="padding: 20px; margin-top: 20px;">
      <!-- <h2>Learn Python</h2> -->
      <h5>The basics of ML: what it is, how it works</h5>
      <h5>Types of learning: Supervised, Unsupervised, Reinforcement</h5>
      <h5>Simple ML algorithms like Linear Regression and KNN</h5>
      <h5>How to train models using Python and libraries like Scikit-learn</h5>
      ...
      <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none;  border-radius: 5px; ">
        <a href="code.php" style="text-decoration: none; color: white;">Code Play »</a>
      </button>
      <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none;  border-radius: 5px; margin-left: 90px;">
        <a href="Numpy1.php" style="text-decoration: none; color: white;">Next »</a>
      </button>
