...
<button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle Sidebar">
    ...
    <div class="custom-sidebar" id="sidebar">
      <h2 class="custom-title">ML Tutorial</h2>
      <ul class="custom-list">
     <a href="ML.php" style="text-decoration: none;">  
      <li class="custom-item" onclick="highlightItem(this)" onmouseover="hoverEffect(this)"
        ...
        <a href="Numpy1.php" style="text-decoration: none;"> 
          <li class="custom-item" onclick="highlightItem(this)" onmouseover="hoverEffect(this)"
          onmouseout="removeHover(this)">
          <div class="custom-slide-bg"></div>
       ...
       <a href="Pandas2.php" style="text-decoration: none;"> 
        <li class="custom-item" onclick="highlightItem(this)" onmouseover="hoverEffect(this)"
          onmouseout="removeHover(this)">
          <div class="custom-slide-bg"></div>
          <span class="custom-label">Pandas</span>
        </li></a>
       <a href="Matplotlib3.php" style="text-decoration: none;"> 
        <li class="custom-item" onclick="highlightItem(this)" onmouseover="hoverEffect(this)"
          onmouseout="removeHover(this)">
          <div class="custom-slide-bg"></div>
          <span class="custom-label">Matplotlib </span>
        </li></a>
        <a href="Seaborn4.php" style="text-decoration: none;"> 
          <li class="custom-item" onclick="highlightItem(this)" onmouseover="hoverEffect(this)"
          onmouseout="removeHover(this)">
          <div class="custom-slide-bg"></div>
          <span class="custom-label">Seaborn</span>
        </li></a>
        ...
        <li class="custom-item" onclick="highlightItem(this)" onmouseover="hoverEffect(this)" onmouseout="removeHover(this)">
          <div class="custom-slide-bg"></div>
          <span class="custom-label">Easytrack</span>
        </li>
      </a>
        <a href="#" style="text-decoration: none;">
        <li class="custom-item" onclick="highlightItem(this)" onmouseover="hoverEffect(this)" onmouseout="removeHover(this)">
          <div class="custom-slide-bg"></div>
          <span class="custom-label">Advancetrack</span>
        </li>
      </a>
      </ul>
    </div>
    ...
    <div style="flex-grow: 1; padding: 20px;">
      ...
      <div style=" padding: 20px; margin-top: 20px;">
        <h5>Congratulations, you’ve made it to the Advanced Track! </h5>
        <h5>You’ve already come a long way, and we’re thrilled to guide you through this next level of your Machine Learning journey.</h5>
        <h5> In this section, you’ll explore more advanced topics and frameworks, such as:</h5>
        <h5>A deeper understanding of Neural Networks</h5>
        <h5>Types of Neural Networks (CNNs, RNNs, etc.)</h5>
        <h5> Optimization techniques for improving models</h5>
        <h5> Applications in real-world scenarios (like image recognition, NLP, etc.)</h5>
         
   <div class="tip-box">
 
  <p>🛠️ Coming Soon <br>We’re still working on this section to give you the best learning experience possible. Stay tuned! <a href="#" target="_blank"><!-- Google Colab --></a>.</p>
</div>
      </div>
      <div style="margin-top: 40px;">
  <a href="ML.php" style="text-decoration: none; margin-right: 10px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      « Prev
    </button>
  </a>
  <!-- <a href="Pandas2.php" style="text-decoration: none; margin-left: 140px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      Next »
    </button>
  </a> -->
