...
<button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle Sidebar">
    ...
    <div style="flex-grow: 1; padding: 20px;">
      <h3 style="font-size: 20px;"> Python  – Part 1</h3>
      <!-- <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none;">Home</button> -->
      <div style=" padding: 20px; margin-top: 20px;">
        <h5>Welcome to Part 1 of the Python Crash Course series!</h5>
        <h5>In this beginner-friendly session, we’ll explore the basics of Python with a hands-on approach. You’ll learn about:</h5>
        <h5>Variables and how to store information</h5>
        <h5>The print() function and displaying output</h5>
        <h5>Common data types like lists, tuples, and dictionaries</h5>
         
   <div class="tip-box">
 
  <p>Run this tutorial notebook on <a href="https://colab.research.google.com/drive/1HFKvs-gB7P7dwuV_Iz2mOB2pOsW2SCIG?usp=sharing" target="_blank">Google Colab</a>.</p>
</div>
      </div>
      <div style="margin-top: 40px;">
  <a href="python.php" style="text-decoration: none; margin-right: 10px;">
