...
<button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle Sidebar">
    ...
    <div style="flex-grow: 1; padding: 20px;">
      <h3 style="font-size: 20px;">SVM</h3>
      <!-- <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none;">Home</button> -->
      <div style=" padding: 20px; margin-top: 20px;">
        <h5>Welcome to the Support Vector Machine</h5>
        <h5>In this session, we’ll dive into how SVM works and how to build one using Python. You’ll learn:</h5>
        <h5>  What is an SVM and how it finds the best decision boundary</h5>
        <h5> Concepts of hyperplanes, support vectors, and margins</h5>
        <h5>Difference between linear and non-linear classification</h5>
        <h5>How to use kernel tricks (like RBF) to handle complex data</h5>
        <h5>  How to train and test an SVM model using Scikit-learn</h5>
         
   <div class="tip-box">
 
  <p>Run this tutorial notebook on <a href="https://colab.research.google.com/drive/1BQ5BaPS2BEWZ0vP7yYpueoz0IZQw5-XS?usp=sharing" target="_blank">Google Colab</a>.</p>
</div>
      </div>
      <div style="margin-top: 40px;">
  <a href="random.php" style="text-decoration: none; margin-right: 10px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      « Prev
    </button>
  </a>
  <a href="kmeans.php" style="text-decoration: none; margin-left: 140px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      Next »
    </button>
  </a>
