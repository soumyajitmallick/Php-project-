...
<button class="sidebar-toggle" id="sidebar-toggle" aria-label="Toggle Sidebar">
    ...
    <div style="flex-grow: 1; padding: 20px;">
      <h3 style="font-size: 20px;">Logistic Regression</h3>
      <!-- <button style="background-color: #6f79ff; color: white; padding: 10px 15px; border: none;">Home</button> -->
      <div style=" padding: 20px; margin-top: 20px;">
        <h5>Welcome to the Logistic Regression </h5>
        <h5>In this session, we’ll explore the fundamentals of Logistic Regression, a key algorithm used for classification problems. You'll learn:</h5>
        <h5> What is Logistic Regression and how it works</h5>
        <h5>Difference between Logistic and Linear Regression</h5>
        <h5>Binary classification use cases (like spam vs not spam)</h5>
        <h5>  How to build and train a Logistic Regression model using Python</h5>
        <h5>Predicting outcomes and evaluating the model (accuracy, confusion matrix, etc.)</h5>

        
         
   <div class="tip-box">
 
  <p>Run this tutorial notebook on <a href="https://colab.research.google.com/drive/1TPhijTvqIPMOjwKtTCqQNFloJu3L6soC?usp=sharing" target="_blank">Google Colab</a>.</p>
</div>
      </div>
      <div style="margin-top: 40px;">
  <a href="linear.php" style="text-decoration: none; margin-right: 10px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      « Prev
    </button>
  </a>
  <a href="decision.php" style="text-decoration: none; margin-left: 140px;">
    <button style="background-color: #6f79ff; color: white; padding: 10px 15px;  border-radius: 5px; border: none;">
      Next »
    </button>
  </a>
